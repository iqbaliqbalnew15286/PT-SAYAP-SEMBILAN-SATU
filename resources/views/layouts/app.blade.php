                ...
                <div class="max-w-screen-xl mx-auto flex items-center justify-center gap-x-8 px-4 h-12">
                    ...
                    <div class="relative group h-full flex items-center">
                        ...
                        <div class="absolute top-full dropdown-content bg-white shadow-xl border border-gray-100 rounded-b-xl py-2 w-52 overflow-hidden">
                            ...
                            <a href="{{ route('partners') }}" class="block px-5 py-3 text-sm text-gray-600 hover:bg-orange-50 hover:text-rbm-accent transition-colors">Mitra Kami</a>
                            <a href="{{ route('send.testimonial') }}" class="block px-5 py-3 text-sm text-gray-600 hover:bg-orange-50 hover:text-rbm-accent transition-colors">Testimonial</a>
                        </div>
                    </div>

                    <a href="{{ route('products') }}" class="nav-link {{ Request::is('products*') ? 'nav-active' : '' }}">Produk</a>
                    <a href="{{ route('facilities') }}" class="nav-link {{ Request::is('facilities*') ? 'nav-active' : '' }}">Fasilitas</a>
                ...
                <div class="flex flex-col p-5 space-y-1 overflow-y-auto max-h-[80vh]">
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition class="bg-gray-50 rounded-xl mx-2 my-1 overflow-hidden">
                            ...
                            <a href="{{ route('partners') }}" class="block px-6 py-3 text-sm text-gray-600">Mitra Industri</a>
                        </div>
                    </div>

                    <a href="{{ route('products') }}" class="px-4 py-3 text-gray-700 font-bold uppercase">Produk</a>
                    <a href="{{ route('facilities') }}" class="px-4 py-3 text-gray-700 font-bold uppercase">Fasilitas</a>
        ...
        <footer style="background-color: {{ $rbmDark }};" class="text-white pt-20">
            <div class="max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-8 pb-16">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    <div class="space-y-6">
                        <img src="{{ asset('assets/img/image.png') }}" alt="Logo Sayap Sembilan Satu"
                            class="h-16 brightness-0 invert opacity-100">
                        <p class="text-rbm-light-text text-sm leading-relaxed">
                            Penyedia solusi infrastruktur menara telekomunikasi dan konstruksi terintegrasi dengan standar profesional tinggi untuk kemajuan konektivitas Indonesia.
                        </p>
                    ...
                    <div>
                        ...
                        <div class="space-y-5 text-sm text-rbm-light-text">
                            ...
                            <div class="flex gap-4 items-center">
                                ...
                                <a href="mailto:info@sayapsembilansatu.co.id" class="hover:text-white transition">info@sayapsembilansatu.co.id</a>
                            </div>
                            <div class="flex gap-4 items-center">
