        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
            <div class="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                <a href="tel:+6221XXXXXXX" class="text-lg font-semibold text-[#2C3E50] hover:text-[#FFC300] transition-colors">
                                    +62 21 XXXX XXXX
                                </a>
                                <p class="text-sm text-[#7F8C8D] mt-1">Pusat Layanan Klien (24/7)</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div>
                                <a href="https://wa.me/6281234567890" target="_blank" class="text-lg font-semibold text-[#2C3E50] hover:text-[#FFC300] transition-colors">
                                    +62 812 3456 7890
                                </a>
                                <p class="text-sm text-[#7F8C8D] mt-1">Kemitraan & Bisnis Development</p>
                            </div>
                        </div>
                ...
                <div class="p-8 md:p-12 bg-gray-50/50">
                    ...
                    <p class="text-sm text-[#7F8C8D] mb-6 italic">Kunjungi kantor pusat kami. Mohon buat janji temu terlebih dahulu.</p>

                    <div class="rounded-2xl overflow-hidden shadow-inner border border-gray-200 h-64 lg:h-72">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.275463282258!2d106.807185!3d-6.227318!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f15053272d1d%3A0x2a3e0f0d9082f42a!2sSCBD!5e0!3m2!1sid!2sid!4v1710000000000!5m2!1sid!2sid"
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="space-y-4">
                            <a href="mailto:info@towermanagement.com" class="flex items-center gap-3 text-[#2C3E50] font-semibold hover:text-[#FFC300] transition group">
                                <i class="bi bi-envelope-at-fill text-xl text-[#FFC300]"></i>
                                info@towermanagement.com
                            </a>
                            <a href="mailto:careers@towermanagement.com" class="flex items-center gap-3 text-[#2C3E50] font-semibold hover:text-[#FFC300] transition group">
                                <i class="bi bi-person-workspace text-xl text-[#FFC300]"></i>
                                careers@towermanagement.com
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="#" class="w-11 h-11 flex items-center justify-center bg-gray-100 rounded-xl text-[#2C3E50] hover:bg-[#FFC300] hover:text-white transition-all transform hover:-translate-y-1 shadow-sm">
