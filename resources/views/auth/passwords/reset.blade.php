...
<head>
    ...
    <title>Reset Password - Tower Management</title>
                    ...
                    <div class="grid grid-cols-2 gap-6 w-full">
                        ...
                        <div class="card-info flex items-center p-6 space-x-4 border-l-4 border-blue-500">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400">Lindungi akses infrastruktur Anda</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 bg-white flex flex-col justify-center px-10 py-16 shadow-[-20px_0_50px_rgba(0,0,0,0.03)] relative z-10">
            ...
            <div class="max-w-md mx-auto w-full">
                <div class="mb-10 text-left">
                    ...
                    <p class="text-sm font-medium text-slate-400">Pulihkan akses administrator Anda</p>
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                    @csrf
                    {{-- Hidden Token for Laravel Security --}}
                    ...
                    <button type="submit"
                        ...
                        Update Password <i class="fa-solid fa-key ml-2"></i>
                    </button>
                </form>
